...
urlpatterns = [
    ...
    re_path(r'^get_items/',views.get_items),
    re_path(r'^remove/(?P<id>\d+)/$', views.remove_item),
    re_path(r'^add/(?P<id>\d+)/$', views.add_item),
    re_path(r'^add_log/', views.add_log),
    re_path(r'^check/', views.check_user),
